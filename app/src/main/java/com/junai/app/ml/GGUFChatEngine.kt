...
object GGUFChatEngine {
    ...
    private const val SYSTEM_INSTRUCTION =
        ...
        "Keep your internal thinking short and decisive — don't repeat the " +
        "same conclusion multiple times before answering. This does not " +
        "limit the length of your actual answer: give as complete an answer " +
