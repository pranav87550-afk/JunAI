    ...
    suspend fun init(context: Context) {
        ...
        withContext(Dispatchers.IO) {
            ...
            try {
                ...
                Breadcrumb.log(context, "ChatEngine: about to construct Engine(engineConfig)")
                appContext = context.applicationContext
                val newEngine = Engine(engineConfig)
                Breadcrumb.log(context, "ChatEngine: Engine() constructed OK, about to call initialize() (native, can take ~10s)")
                ...
                Breadcrumb.log(context, "ChatEngine: initialize() returned OK")
                engine = newEngine
