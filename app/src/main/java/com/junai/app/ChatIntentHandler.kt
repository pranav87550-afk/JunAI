 ...
 *
 * Phase 2: every turn is now also captured into MemoryRepository, which
 * scores it via ImportanceEngine and lets the hybrid memory system decide
...
class ChatIntentHandler(
    ...
    init {
        // Runs ranking/promotion/forgetting once per session start
