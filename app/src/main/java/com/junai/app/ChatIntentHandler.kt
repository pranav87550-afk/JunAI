 ...
 * Phase 6 (NEW): RuleRepository/ReasoningEngine — IF/AND/OR/NOT rules over
 * live device state (battery%, charging, hour). Hooked into GREET and
 * TELL_BATTERY, the two moments where a proactive suggestion feels natural
