...
class ChatAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is UserViewHolder) {
            ...
            holder.messageText.text = if (message.isThinking) "Jun is thinking…" else message.text
            holder.timeText.text = time
            ...
            if (message.thinkingText.isBlank()) {
                ...
                holder.thinkingContent.text = message.thinkingText
            ...
            // not auto-speaking a mid-stream partial answer.
            val actionButtonsVisibility = if (message.isThinking) View.GONE else View.VISIBLE
