...
object ScreenContextEngine {
    ...
    data class ScreenContext(
        ...
        // Set by JunAccessibilityService.detectBlockingOverlay() — "keyboard",
        // "system_popup", "overlay", or null when nothing is covering the
        // app's own content. Lets ActionEngine refuse to act (and say why)
        // instead of matching against whatever's underneath the overlay.
        val blockingOverlay: String? = null,
    ...
    /** Human-readable reason if something is covering the app's own screen, else null. */
    fun currentBlockingOverlay(): String? = _currentContext.value.blockingOverlay
